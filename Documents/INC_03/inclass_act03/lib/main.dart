...
class _ControlDeckScreenState extends State<ControlDeckScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    // --- MILESTONE 2: Overload detection ---
    // Whenever the power slider crosses 80%, we flag "overload" and let that
    // flag drive both the background color and the status banner color.
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          // Milestone 2: energy readout turns red once overloaded
                          color: isOverload ? Colors.redAccent : Colors.blueAccent,
                        ),
                      ),
                    ],
                  ),
            ...
            // Live System Status Banner (now overload-aware)
            Text(
              isOverload ? "STATUS: $systemStatus  ⚠ OVERLOAD" : "STATUS: $systemStatus",
              style: TextStyle(
            ...
            // Persona: Weather Command Center — Sun, Rain, Wind, Storm
            Wrap(
              spacing: 20,
              runSpacing: 20,
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("SOLAR SURGE"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("RAINFALL"),
                ),
                TactileButton(
                  icon: Icons.air,
                  label: "WIND",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("WIND GUST"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("STORM WARNING"),
                ),
              ],
            ),
            ...
            Slider(
              ...
              min: 0,
              max: 100,
              // Milestone 2: slider track itself flashes red past 80%
              activeColor: isOverload ? Colors.redAccent : Colors.blueAccent,
